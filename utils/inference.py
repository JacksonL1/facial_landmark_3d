...
def predict_68pts(param, roi_box, shape):
    return _predict_vertices(param, roi_box, shape, dense=False)


def predict_dense(param, roi_box, shape):
    return _predict_vertices(param, roi_box, shape, dense=True)
